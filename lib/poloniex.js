module.exports = (function() {
    ...
    Poloniex.prototype = {
        ...
        returnOrderBook: function(currencyA, currencyB, orderDepth, callback) {
            var parameters = {
                currencyPair: joinCurrencies(currencyA, currencyB)
            };

            if (typeof(orderDepth) !== 'undefined' && orderDepth !== null) {
                parameters.depth = orderDepth;
            }
        ...
        buy: function(currencyA, currencyB, rate, amount, mode, callback) {
            var parameters = {
                currencyPair: joinCurrencies(currencyA, currencyB),
                rate: rate,
                amount: amount
        ...
        sell: function(currencyA, currencyB, rate, amount, mode, callback) {
            var parameters = {
                currencyPair: joinCurrencies(currencyA, currencyB),
                rate: rate,
                amount: amount
